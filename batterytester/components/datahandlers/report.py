...
class MarkDownReport(FileBasedDataHandler):
    def __init__(
        ...
        """
        super().__init__(report_name, output_path, subscription_filters)
...
class Report(MarkDownReport):
    ...
    def _test_warmup(self, subject, data: TestData):
        ...
        self.start_time = datetime.fromtimestamp(data.started.value)
    ...
    def _test_finished(self, subject, data: TestFinished):
        self.stop_time = datetime.fromtimestamp(data.time_finished.value)
